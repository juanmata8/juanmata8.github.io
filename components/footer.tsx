  ...
  return (
    <footer ref={sectionRef} className="relative bg-gradient-to-b from-background to-card border-t border-border">
      <div className="max-w-[800px] mx-auto px-4 sm:px-6 py-20 sm:py-28">
        ...
        >
          <h3 className="font-sans text-foreground font-medium mb-4 flex items-center gap-3">
          ...
          <p className="text-sm text-muted-foreground leading-relaxed">
            This analysis examines SFPD incident reports categorized under prostitution-related 
            offenses from 2003 to 2025. Incident locations were geocoded and aggregated by 
            neighborhood, time of day, and date. The dataset includes only reported incidents 
            and may not reflect the full scope of activity.
          </p>
        </div>
